            ...
            <div className="box1">
              ...
              <Container>
                <div className="spacing">
                  ...
                  <div className="info">
                  <a href="#" onClick={(e) => {e.preventDefault(); window.open("https://alyssavmeczkowska.github.io/personal-site/resume.pdf", "_blank");}}className="a a2 one">Resume <ArrowRightCircle size={25} /></a>
